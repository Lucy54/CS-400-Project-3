...
public class CS400Graph<T> implements GraphADT<T> {
    ...
    protected class Path implements Comparable<Path> {
        ...
        public Path(Path source) {
            //Step 5: makes copy of path fields and iterates through source
        ...
        public void extend(Edge edge) {
            //Step 6: allows program to extend path by an edge.
    ...
    /**
     * Returns the cost of the path (sum over edges) between start and end.
     * Uses Dijkstra's shortest path algorithm to find the shortest path.
     * 
     * @param start the data item in the starting vertex for the path
